...
if [ "$1" == "hs" ]; then
	...
	commandline="-batch_size 10 -max_epoch 100 -valid_per_batch 280 -save_per_batch 280 -decode_max_time_step 350 -optimizer adadelta -rule_embed_dim 128 -node_embed_dim 64 -valid_metric bleu"
	datatype="conala"
else
	# django dataset
